...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        m1 = other1.elements;
        m2 = other2.elements;
        x = m1[1]*m2[2]-m1[2]*m2[1];
        y = -1*(m1[0]*m2[2]-m2[0]*m1[2]);
        z = (m1[0]*m2[1])-(m2[0]*m1[1]);
        // Don't delete the return statement.
    ...
    magnitude() {
        ...
        var val = this.elements;
        m = Math.pow(val[0], 2) + Math.pow(val[1], 2) + Math.pow(val[2], 2);
        m = Math.sqrt(m);
        // Don't delete the return statement.
        return m;
    };
